...
public class Solo extends MainActivity {
...
//    private ArgbEvaluator argbEvaluator = new ArgbEvaluator();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        models.add(new Model("smalasolo"));//nama n logo sekolah
        models.add(new Model("smansixsolo"));


        ViewPager slideViewPager = findViewById(R.id.slideViewPager);
        dots = findViewById(R.id.dots);

        SliderAdapter sliderAdapter = new SliderAdapter(this, models, "Solo");
