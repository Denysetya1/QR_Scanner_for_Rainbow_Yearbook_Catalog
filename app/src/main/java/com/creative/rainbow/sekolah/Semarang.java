...
public class Semarang extends MainActivity {
...
//    private ArgbEvaluator argbEvaluator = new ArgbEvaluator();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initBackgroundImg2();
        //ditambah jika ada sekolah baru, jangan lupa dot nya juga
        List<Model> models = new ArrayList<>();
        //models.add(new Model("smandasem"));
        models.add(new Model("smagasem"));
        models.add(new Model("smalasem"));
        models.add(new Model("smansixsem"));
        models.add(new Model("smansesem"));

        ViewPager slideViewPager = findViewById(R.id.slideViewPager);
        dots = findViewById(R.id.dots);

        SliderAdapter sliderAdapter = new SliderAdapter(this, models, "Semarang");
